...
if (agentIndex === 1) {
    ...
    const board = upsilon.waitNextTurn(); // Blocks until board.updated (won) or game.ended
    
    // We check results after match termination
    upsilon.sleep(2000); // Wait for backend to process progression
    ...
    // (Actual allocation is tested in CR-10)
}
